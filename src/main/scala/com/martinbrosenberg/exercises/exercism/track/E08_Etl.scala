...
/** ETL
  ...
  * once." That's then typically followed by much forehead slapping and moaning
  * about how stupid we could possibly be.)
  *
  * The goal
  *
  ...
  * stores the letters in lower-case regardless of the case of the input
  * letters:
  *
  * "a" is worth 1 point.
  * "b" is worth 3 points.
  ...
  * Etc.
  *
  * Your mission, should you choose to accept it, is to transform the legacy
  * data format to the shiny new format.
  *
  * Notes
  *
  * A final note about scoring, Scrabble is played around the world in a variety
  * of languages, each with its own unique scoring table. For example, an "E" is
